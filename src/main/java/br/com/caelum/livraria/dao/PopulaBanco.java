...
public class PopulaBanco {
	...
	public static void main(String[] args) {
		...
		livroDao.adiciona(casmurro);
		livroDao.adiciona(memorias);
		livroDao.adiciona(quincas);
		...
		livroDao.adiciona(alquemista);
		livroDao.adiciona(brida);
		livroDao.adiciona(valkirias);
		livroDao.adiciona(maao);
		...
		livroDao.adiciona(capitaes);
		livroDao.adiciona(flor);
